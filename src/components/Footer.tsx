        ...
        <div className=" mt-10 mb-10 container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-lg">
              <Link href={"#"}>
                <li className="py-1">Programming Fundamentals</li>
              </Link>
              <Link href={"#"}>
                <li className="py-1">Web2 Using NextJs </li>
              </Link>
              <Link href={"#"}>
                <li className="py-1">Earn As You Learn</li>
              </Link>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-lg">
              <Link href={"#"}>
                <li className="py-1">Web 3 and Metaverse</li>
              </Link>
              <Link href={"#"}>
                <li className="py-1">Cloud-Native Computing</li>
              </Link>
              <Link href={"#"}>
                <li className="py-1">
              ...
              <Link href={"#"}>
                <li className="py-1">Ambient Computing and IoT</li>
              </Link>
              <Link href={"#"}>
                <li className="py-1">Genomics and Bioinformatics</li>
              </Link>
              <Link href={"#"}>
                <li className="py-1">Network Programmability and Automation</li>
              </Link>
            </ul>
          </div>
          <div>
            ...
            <div className="flex space-x-4 mb-4 py-1">
              ...
              <Link href={"#"}>
                <FaInstagram className="insta text-white w-6 h-6 rounded-full  pt-1 pb-1" />
              </Link>
              <Link href={"#"}>
